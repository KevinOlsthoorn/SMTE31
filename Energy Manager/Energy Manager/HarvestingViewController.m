...
- (void)viewDidLoad
{
    ...
    lineStyle.lineColor              = [CPTColor colorWithComponentRed:0.44 green:0.56 blue:0.71 alpha:1];
    plot.dataLineStyle = lineStyle;
    
    // Put an area color under the plot above
    CPTColor *areaColor       = [CPTColor colorWithComponentRed:0.44 green:0.56 blue:0.71 alpha:0.2];
    ...
    CGFloat yMax = [[graphDataDictionary valueForKeyPath:@"@max.dailyenergy.floatValue"] floatValue]; // Determine the maximum y-value.
...
- (void)parseJson
{
    ...
    graphData = [[NSData alloc] initWithContentsOfURL:[NSURL URLWithString:@"http://www.energy.xk140.nl/json_data.php?type=harv"]];
